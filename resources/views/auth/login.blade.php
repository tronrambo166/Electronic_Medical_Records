...
<div class="container bg-light pt-4">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">{{ __('Health Care Professional Login') }}</div>
                ...
                <div class="card-body px-3 pt-0">
                    ...
                    <div class="row pb-3" style="background:#7c563cf0;">
                        <div class="w-100 text-center ">
                           ...
                           <h2 class="py-5 text-light text-center">L O G O</h2>
                        </div>
                       
                        <div>
                            <p style="font-weight: 400;color:#f7f7f7b8;" class="text-center  h4 py-3">The most popular open source Electronic Health Record and Medical Practise Management solution</p>

                            <p style="font-weight: 400;color:#f7f7f7b8;" class="text-center py-3 h5">Acknowledgements, Licensing and Certification</p>
