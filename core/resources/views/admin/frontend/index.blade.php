                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="overview-wrapper">
                                                    <div class="user-detail-thumb two">
                                                        <span class="title text-center p-2">{{__(inputTitle(@$imgKey))}}</span>
                                                        ...
                                                        <div class="sub-title pt-20">
                                                            <span class="p-2">Supported files: <strong>jpeg, jpg, png.</strong> | Will be resized to: <strong>
                                        ...
                                        @if($k != 'images')
                                            ...
                                            @elseif($item == 'textarea')
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="form-control-label   font-weight-bold">{{__(inputTitle($k))}}</label>
                                                        <textarea rows="5" style="height: 150px" class="form-control form--control " placeholder="{{__(inputTitle($k))}}" name="{{$k}}" required>{{ @$content->data_values->$k}}</textarea>
                                                    </div>
                                                </div>
    ...
    @if(@$section->element)
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                       <div class="card-header text-right" style="text-align: right">
                        @if($section->element->modal)
                        <a href="javascript:void(0)" class="btn btn-sm btn--base box--shadow1 text--small addBtn text-right"><i class="fa fa-fw fa-plus"></i>@lang('Add New')</a>

                        @else
                            <a href="{{route('admin.frontend.sections.element',$key)}}" class="btn btn-sm btn--base box--shadow1 text--small text-right"><i class="fa fa-fw fa-plus"></i>@lang('Add New')</a>
                        @endif
                       </div>
                                ...
                                @if($k != 'modal')
                                    ...
                                    @elseif($type == 'textarea')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea rows="4" class="form-control" style="height: 150px" placeholder="{{__(inputTitle($k))}}" name="{{$k}}" required></textarea>
                                        </div>
