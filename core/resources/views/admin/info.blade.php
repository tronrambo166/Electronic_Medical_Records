                ...
                <div class="row mb-30-none">
                    <div class="col-lg-12 mb-30">
                        <div class="user-info-header two">
                            <h5 class="title">System Information</h5>
                        </div>
                        <div class="dashboard-form-area two mt-10">
                            <div class="pending-deposit-content-area mt-20">
                                <ul class="content-list">
                                    <li>PHP Version : <span>{{ $currentPHP }}</span></li>
                                    <li>Laravel Version : <span>{{ $laravelVersion }}</span></li>
                                    <li>Server Software : <span>{{ @$serverDetails['SERVER_SOFTWARE']  }}</span></li>
                                    <li>Server IP Address : <span>{{ @$serverDetails['SERVER_ADDR'] }}</span></li>
                                    <li>Server Protocol : <span>{{ @$serverDetails['SERVER_PROTOCOL'] }}</span></li>
                                    <li>HTTP Host : <span>{{ @$serverDetails['HTTP_HOST']  }}</span></li>
                                    <li>Database Port: <span>{{ @$serverDetails['DB_PORT'] }}</span></li>
                                    <li>App Environment : <span>{{ @$serverDetails['APP_ENV'] }}</span></li>
                                    <li>App Debug : <span>{{ @$serverDetails['APP_DEBUG'] }}</span></li>
