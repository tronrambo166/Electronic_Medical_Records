<?php
	if(isset($_POST['db_name']) && isset($_POST['db_username']) && isset($_POST['db_password']) && isset($_POST['db_host']) && isset($_POST['add_username']) && isset($_POST['add_password']))
	{
		...
		{ 
			...
			$insCheck->tables = array(
				'calendar' => array('id', 'title', 'description', 'start', 'end', 'allDay', 'color', 'url', 'category', 'repeat_type', 'user_id', 'repeat_id', 'timezone'),
				'users' => array('id', 'username', 'password')
			);
...
<head>
	...
	<title>Ajax Full Featured Calendar 5 Installation</title>
                ...
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                            	<input name="add_password" class="form-control" id="req" type="password" size="32" value="<?php echo $f_db_admin_password; ?>" />
